...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Wikipedia CLI — Every Wikipedia reading pattern as a composable command — with structured output, offline cache, and an agent-native su…`,
		Long: `Wikipedia CLI — Every Wikipedia reading pattern as a composable command — with structured output, offline cache, and an agent-native su…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	// Novel top-level commands (hand-authored Phase 3)
